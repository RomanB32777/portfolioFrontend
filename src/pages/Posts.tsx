import React, { useEffect, useContext, useCallback, useState, Suspense } from 'react'
...
import { PostList } from '../components/postsPageComponents/PostList'
    ...
    return (
        <div>
            <div className="container">
                ...
                <div className="row">
                    {loading && <Loader />}
                    {!loading && state.posts && <PostList posts={state.posts} />}
                </div>
