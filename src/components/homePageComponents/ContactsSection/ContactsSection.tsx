...
import info from '../../../configInfo/info.json'
                        ...
                        <div className="contacts__wrap wrap col s12 l6 m6">
                            ...
                            <ul className="contacts__list contacts">
                                <li className="contacts__item gps">
                                    ...
                                    <p>{info.contacts.location}</p>
                                </li>
                                <li className="contacts__item telephone">
                                    <img src={require('../../../img/telephone.png')} alt="" />
                                    <a href={info.contacts.tel.hrefTel} target="_blank" rel="noreferrer noopener">{info.contacts.tel.printTel}</a>
                                    {/* <p>{info.contacts.tel.printTel}</p> */}
                                </li>
                                <li className="contacts__item email">
                                    <img src={require('../../../img/email.png')} alt="" />
                                    <a href={info.contacts.email.hrefEmail} target="_blank" rel="noreferrer noopener">{info.contacts.email.printEmail}</a>
