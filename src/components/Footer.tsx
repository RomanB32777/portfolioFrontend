...
import { NavigationMenu } from "./headerComponents/navigation/NavigationMenu";
              ...
              <div className="row" style={{ marginBottom: 0 }}>
                ...
                <ul className="footer__links col s12 l9">
                  <li className="links__item">
                    <a href={info.social.github} rel="noopener noreferrer" target="_blank">
                      <i className="fab fa-github"></i>
                      {/* <img src={require('../img/git.svg')} alt="" /> */}
                    </a>
                  </li>
                  <li className="links__item">
                    <a href={info.social.instagram} rel="noopener noreferrer" target="_blank">
                  ...
                  <li className="links__item">
                    <a href={info.social.vk}  rel="noopener noreferrer" target="_blank">
